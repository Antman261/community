...
def create_exploded_forms(
    spoken_forms: List[str], words_to_exclude: Optional[list[str]] = []
):
...
def create_spoken_forms_from_regex(
    source: str, pattern: re.Pattern, words_to_exclude: Optional[list[str]] = []
):
    """
