...
<user.teleport> camel left: user.camel_left()
<user.teleport> camel right: user.camel_right()
<user.delete> camel left: user.delete_camel_left()
<user.delete> camel right: user.delete_camel_right()
